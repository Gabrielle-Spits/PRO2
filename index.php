                ...
                <div id="carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./img/Daltonlaan-opti.jpg" class="d-block w-100 " alt="...">
                        </div>
            ...
            <div class="col-12">
                <div class="jumbotron">
                    ...
                    <p class="lead">Welkom op deze website. 
                        ...
                        Ook is er een game die je kan spelen en Als je deze opleiding nu al leuk vindt kan je je al inschrijven onder het kopje aanmelden.</p>
                </div>
            </div>
        </div>
